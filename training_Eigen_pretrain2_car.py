...
MODEL_NAME = "Eigen_pretrain_2_car"
...
def main():
    ...
    coarse5 = tf.layers.conv2d(coarse4, 256, 3, activation=tf.nn.relu, padding='valid', trainable=False)
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, "saved_Eigen_pretrain_1_car/model.ckpt")
        print('training ')
